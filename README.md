...
1. **کل متن داخل کادر بالا را کپی کنید**
2. یک فایل جدید در ویرایشگر متن بسازید
3. متن را پیست کنید
4. فایل را با نام `README.md` ذخیره کنید
5. **حتماً انکدینگ را روی `UTF-8` قرار دهید** تا حروف فارسی به‌درستی نمایش داده شوند
6. فایل را در ریشه مخزن گیت‌هاب خود آپلود کنید

حالا فایل `README.md` شما به‌صورت کامل و زیبا در گیت‌هاب نمایش داده خواهد شد. ✅
